package com.example.test_covid.Hospitals;
...
public class HospitalActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    public void onClick(View v)
    {
        ...
        GetNearbyPlacesDataH getNearbyPlacesData = new GetNearbyPlacesDataH();
        ...
        switch(v.getId())
        {
            case R.id.B_hospitals:
                ...
                Toast.makeText(HospitalActivity.this, "Showing Nearby Hospitals", Toast.LENGTH_SHORT).show();
                break;
