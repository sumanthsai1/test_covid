package com.example.test_covid.MedicalStores;
...
public class MedicalStoresActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(MedicalStoresActivity.this, MainActivity.class));
            }
        });
    ...
    public void onClick(View v)
    {
        ...
        GetNearbyPlacesDataM getNearbyPlacesData = new GetNearbyPlacesDataM();

        switch(v.getId())
        {
            case R.id.B_medical_shops:
                mMap.clear();
                ...
                Toast.makeText(MedicalStoresActivity.this, "Showing Nearby Medical Shops", Toast.LENGTH_SHORT).show();
                break;
        }
    }
